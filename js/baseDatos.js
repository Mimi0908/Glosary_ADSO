const glosary=[
    ...
    { num:294, word:"Security Standards", explain:": Established criteria and benchmarks for maintaining security in software and systems.", phonetic:"[sɪˈkjʊə.rə.ti ˈstæn.dəds]"},
    { num:295, word:"Security testing", explain:"Assessing the security aspects of a system to identify vulnerabilities and weaknesses.", phonetic:"[sɪˈkjʊə.rə.ti ˈtes.tɪŋ]"},
    { num:296, word:"Sequencing", explain:"The act of arranging things in a specific order or sequence.", phonetic:"[ˈsiː.kwən.sɪŋ]"},
    { num:297, word:"Server", explain:"A computer that provides services to other computers over a network, such as websites, emails, and files.", phonetic:"[ˈsɜː.vər]" },
    { num:298, word:"Server-side Scripting", explain:"Executing scripts on the server to generate dynamic web content.", phonetic:"[ˈsɜː.vər saɪd skrɪpt.ɪŋ]"},
    { num:299, word:"Setting up", explain:"The process of configuring or preparing something for use.", phonetic:"[ˈset.ɪŋ ʌp]" },
    { num:300, word:"Shell", explain:"A command-line interface for interacting with a computer operating system.", phonetic:"[ʃel]" },
    { num:301, word:"Smoke test", explain:"A basic test to quickly verify if a system or application is functioning at a minimum level.", phonetic:"[sməʊk test]"},
    { num:302, word:"SOAP (Simple Object Access Protocol)", explain:"A protocol for exchanging information between applications using XML and web services.", phonetic:"[səʊp]" },
    { num:303, word:"Software bug", explain:"An error in software code causing issues.", phonetic:"[ˈsɒft.weər bʌɡ]"},
    { num:304, word:"Software containers", explain:"Packaging software with all dependencies for easy deployment.", phonetic:"[ˈsɒft.weər]"},
    { num:305, word:"Software engineering", explain:"The systematic application of engineering principles to the design, development, testing, and maintenance of software.", phonetic:"[ˈsɒft.weər ˌen.dʒɪˈnɪə.rɪŋ]" },
    { num:306, word:"software testing", explain:"The process of evaluating and validating software to ensure it meets requirements and operates as expected.", phonetic:"[ˈsɒft.weər ˈtes.tɪŋ]"},
    { num:307, word:"Software", explain:"A collection of instructions that tell a computer how to perform specific tasks.", phonetic:"[ˈsɒft.weər]" },
    { num:308, word:"SOLID principles", explain:"A set of object-oriented design principles for creating maintainable and flexible software.", phonetic:"[ˈsɒl.ɪd ˈprɪn.sə.pəls]" },
    { num:309, word:"Sort", explain:"The process of arranging items in a specific order, such as numerically or alphabetically.", phonetic:"[sɔːt]"},
    { num:310, word:"Source code", explain:"Human-readable instructions written by a programmer.", phonetic:"[sɔːs kəʊd]"},
    { num:311, word:"Source", explain:"The origin of something, such as data, code, or information.", phonetic:"[sɔːs]" },
    { num:312, word:"Speakers", explain:"Devices that produce sound, often used for listening to music, movies, or other audio content.", phonetic:"[ˈspiː.kərs]"},
    { num:313, word:"SQL (Structure Query Language)", explain:"A language for interacting with relational databases.", phonetic:"[ˈstrʌk.tʃər ˈkwɪə.ri ˈlæŋ.ɡwɪdʒ]"},
    { num:314, word:"SSL (Secure Sockets Layer)", explain:"A security protocol that encrypts data transmitted over the internet, protecting it from eavesdropping and tampering.", phonetic:"[sɪˈkjʊər ˈsɒk.ɪts ˈleɪ.ər]" },
    { num:315, word:"Steps", explain:"A sequence of actions taken to achieve a goal.", phonetic:"[steps]"},
    { num:316, word:"Storage device", explain:"A device used to store data, such as a hard drive, SSD, or USB drive.", phonetic:"[ˈstɔː.rɪdʒ dɪˈvaɪs]" },
    { num:317, word:"Storage", explain:"The act of saving or keeping data for future use.", phonetic:"[ˈstɔː.rɪdʒ]" },
    { num:318, word:"Stored data", explain:"Data that has been saved for future use.", phonetic:"[stɔːrd ˈdeɪ.tə]"},
    { num:319, word:"Stress tests", explain:"Tests that are designed to push a system or application to its limits to identify potential failures.", phonetic:"[stres tests]" },
    { num:320, word:"Subversion", explain:"A version control system that allows users to track changes to files and folders.", phonetic:"[səbˈvɜː.ʃən]"},
    { num:321, word:"Swift", explain:"It is a programming language developed by Apple for creating applications for iOS, macOS, watchOS, and tvOS. It is known for its concise syntax and focus on safety and performance.", phonetic:"[swɪft]" },
    ...
    { num:323, word:"System connector", explain:"A component linking different parts of a system or program.", phonetic:"[ˈsɪs.təm kəˈnek.tər]"},

    { num:324, word:"Task", explain:"A unit of work that needs to be completed.", phonetic:"[tɑːsk]" },
    { num:325, word:"Technical Debt", explain:"Accumulated compromises in code quality that may require future attention.", phonetic:"[ˈtek.nɪ.kəl det]" },
    { num:326, word:"Terminator", explain:"A program that terminates other programs.", phonetic:"[ˈtɜː.mɪ.neɪ.tər]" },
    { num:327, word:"Test Automation", explain:"Running tests automatically using software.", phonetic:"[test ˌɔː.təˈmeɪ.ʃən]"},
    { num:328, word:"Test Cases", explain:"Specific conditions or scenarios designed to verify the functionality of a software application.", phonetic:"[test keɪs]" },
    { num:329, word:"Test Coverage", explain:"The extent to which a system has been tested, measured by the percentage of code or functionality covered.", phonetic:"[test ˈkʌv.ər.ɪdʒ]" },
    { num:330, word:"Test Execution", explain:"Running the tests to evaluate the behavior and performance of a software application.", phonetic:"[test ˌek.sɪˈkjuː.ʃən]" },
    { num:331, word:"Test Metrics", explain:"Quantifiable measures used to assess the effectiveness and progress of testing activities.", phonetic:"[test ˈmetrɪks]"},
    { num:332, word:"Test Plan", explain:"A comprehensive document outlining the testing approach, scope, resources, and schedule.", phonetic:"[test plæn]" },
    { num:333, word:"Test Results", explain:"The outcomes and findings from the execution of software tests.", phonetic:"[test rɪˈzʌlts]" },
    { num:334, word:"Test Strategy", explain:"The overall plan for testing, including the scope, resources, and testing methods.", phonetic:"[test ˈstræt.ə.dʒi]" },
    { num:335, word:"Test Suites", explain:"A collection of test cases that are executed together to validate different aspects of a system.", phonetic:"[test swiːt]"},
    { num:336, word:"Tester", explain:"A person who tests software to ensure it meets requirements and operates as expected.", phonetic:"ˈtes.tər]" },
    { num:337, word:"Text editor", explain:"A program used to create and edit text files.", phonetic:"[tekst ˈed.ɪ.tər]" },
    { num:338, word:"Text-based interface", explain:"Interaction with a computer through text.", phonetic:"[tekst-beɪst ˈɪn.tə.feɪs]"},
    { num:339, word:"The call", explain:"The act of making a phone call or using a communication service.", phonetic:"[ðiː kɔːl]" },
    { num:340, word:"Threat intelligence", explain:"Gathering and analyzing information about potential cybersecurity threats.", phonetic:"[θret ɪnˈtel.ɪ.dʒəns]" },
    { num:341, word:"Threat modeling", explain:"Identifying potential security threats and planning countermeasures during the design phase.", phonetic:"[θret ˈmɒd.əl.ɪŋ]"},
    
    { num:342, word:"UI (User Interface)", explain:"The part of a software application that users interact with.", phonetic:"[ˌjuːˈaɪ]" },
    { num:343, word:"Unauthorized access", explain:" Illegitimate entry into a system or network.", phonetic:"[ʌnˈɔː.θə.raɪzd ˈæk.ses]" },
    { num:344, word:"Unit test", explain:"Tests that are designed to test individual units of code, such as functions or methods.", phonetic:"[ˈjuː.nɪt test]" },
    { num:345, word:"Until", explain:"A conjunction used to indicate a point in time before which something will happen.", phonetic:"[ənˈtɪl]"},
    { num:346, word:"Usability", explain:"The ease with which a user can use a product or service.", phonetic:"[ˌjuːzəˈbɪləti]" },
    { num:347, word:"USB Flash Drive", explain:"A portable storage device that uses flash memory.", phonetic:"[ˌjuː.esˈbiː flæʃ draɪv]" },
    { num:348, word:"User Authentication", explain:"Verifying the identity of users accessing a system.", phonetic:"[ˈjuː.zər ɔːˌθen.tɪˈkeɪ.ʃən]" },
    { num:349, word:"User Authorization", explain:"Granting or restricting access rights to users based on their roles or permissions.", phonetic:"[ˈjuː.zər ˌɔː.θər.aɪˈzeɪ.ʃən]"},
    { num:350, word:"UX (User Experience)", explain:"The overall experience of using a product or service.", phonetic:"[ˌjuːˈeks]" },
    
    { num:351, word:"Variables", explain:"Named locations in memory that store data.", phonetic:"[ˈveə.ri.ə.bəls]" },
    { num:352, word:"Version Control", explain:"Managing changes in software code over time.", phonetic:"[ˈvɜː.ʃən kənˈtrəʊl]" },
    { num:353, word:"Visual Basic .Net", explain:"A programming language that allows users to create Windows applications.", phonetic:"[ˈvɪʒ.u.əl ˈbeɪ.sɪk net]" },
    { num:354, word:"VITE", explain:"It could refer to 'life' in various languages, but in some technical contexts, it might be an abbreviation for 'Vue.js Integrated Template Engine,' an integrated template engine for Vue.js, a JavaScript framework.", phonetic:"[vit]"},
    { num:355, word:"Vulnerability Management", explain:"Identifying, prioritizing, and addressing vulnerabilities in a systematic way.", phonetic:"[ˌvʌl.nər.əˈbɪl.ə.ti ˈmæn.ɪdʒ.mənt]" },
    { num:356, word:"Vulnerability Scanning", explain:"Identifying and assessing potential vulnerabilities in a system.", phonetic:"[ˌvʌl.nər.əˈbɪl.ə.ti skæn.nɪŋ]" },
    
    { num:357, word:"Web Applications", explain:"Applications accessed and operated through web browsers.", phonetic:"[web ˌæp.lɪˈkeɪ.ʃəns]" },
    { num:358, word:"Web browser", explain:"Software used to access and navigate websites.", phonetic:"[web ˈbraʊ.zər]" },
    { num:359, word:"Webhook", explain:"A way for an app to provide other applications with real-time information.", phonetic:"[ˈwɛb.hʊk]" },
    { num:360, word:"While loop", explain:"A programming loop that repeats a block of code until a condition is met.", phonetic:"[waɪl luːp]"},
